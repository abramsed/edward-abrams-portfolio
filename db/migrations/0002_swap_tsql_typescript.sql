-- Swap the item text for TypeScript and T-SQL to reorder them
UPDATE "skill_items" SET "item" = '__TEMP__' WHERE "item" = 'TypeScript' AND "category_id" = (SELECT "id" FROM "skill_categories" WHERE "label" = 'Languages');
...
-- Remove "the" before company's/organization's
