...
export default function SkillCard({ label, icon, items }: SkillCategory) {
  return (
    <div className="rounded-xl border border-blue-800 bg-blue-900 p-6 transition-colors hover:border-rose-400 outline-none" style={{ WebkitTapHighlightColor: 'transparent' }}>
